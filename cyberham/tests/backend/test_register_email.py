...
class TestRegisterEmail(BackendPatcher):
    ...
    def test_already_registered(self):
        ...
        assert not self._has_pending_verify(valid_user()), (
            "Should not send a verification code to users not changing their email"
        )
        assert self._no_offenses(valid_user()), (
    ...
    def test_register_email(self):
        ...
        assert self._no_offenses(unregistered_user()), (
    ...
    def test_registered_new_email(self):
        ...
        assert self._no_offenses(no_email_user()), (
    ...
    def test_register_offense(self):
        ...
        for i in range(1, 10):
            ...
            if i == 0:
                ...
                assert self._offense_count(flagged_user()) == i, (
            ...
            if i < 3:
                ...
                assert prev_pending["code"] == pending["code"], (
    ...
    def _assert_valid_pending_email(self, user: User, email: str):
        ...
        assert pending is not None
        assert pending["user_id"] == user["user_id"], (
