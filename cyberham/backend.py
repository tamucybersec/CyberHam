...
def init_db():
    ...
    # create index mappings that define the structure of the "table" equivalent in nosql
...
def create_event(name: str, points: int, date: str, resources: str, user_id: int):
    ...
    while code_list is not None:
        ...
        # client.search(index = "events", query: {"match": {"code": code}})

        # client.search(index = "events", 
        #               query = {"name":
        #                        {"match": 
        #                         {"code": {"query": code}}}})
        # client.search(index = "events",
        ...
        # The above two pieces of code attempt to return a list of documents where the code value matches the generated code. We still need to return just a list of event names. 
